...
var Select = _react2['default'].createClass({
	...
	getFocusableOptionIndex: function getFocusableOptionIndex(selectedOption, previousIndex) {
	...
	render: function render() {
		...
		var value = valueArray[valueArray.length - 1].value;
		// Cannot use indexOf with objects
		var previousIndex = this._visibleOptions.reduce(function (a, c, i) {
			return c.value === value ? i : a, -1;
		});
		var options = this._visibleOptions = this.filterOptions(this.props.multi ? valueArray : null);
		var isOpen = this.state.isOpen;
		if (this.props.multi && !options.length && valueArray.length && !this.state.inputValue) isOpen = false;
		var focusedOptionIndex = this.getFocusableOptionIndex(valueArray[0], previousIndex);
